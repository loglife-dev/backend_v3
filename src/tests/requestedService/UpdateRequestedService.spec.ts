...
import { UpdateRequestedServiceUseCase } from "../../modules/requestedService/useCases/update/RequestedServiceUseCase";
...
let updateRequestedServiceUseCase: UpdateRequestedServiceUseCase;

describe("Update RequestedService", () => {
    beforeEach(() => {
    ...
    updateRequestedServiceUseCase = new UpdateRequestedServiceUseCase(requestedServiceRepositoryInMemory);
    });

    it("should be able to update one RequestedService", async () => {
        ...
        expect(updateRequested.observation).toBe("teste");
    })
})
