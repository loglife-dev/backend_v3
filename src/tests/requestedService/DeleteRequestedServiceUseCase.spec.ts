...
import { DeleteRequestedServiceUseCase } from "../../modules/requestedService/useCases/delete/RequestedServiceUseCase";
...
let deleteRequestedServiceUseCase: DeleteRequestedServiceUseCase;

describe("Delete RequestedService", () => {
    beforeEach(() => {
        ...
        deleteRequestedServiceUseCase = new DeleteRequestedServiceUseCase(requestedServiceRepositoryInMemory);
    });

    it("should be able to delete a requestedService", async () => {
        ...
        const findId = await deleteRequestedServiceUseCase.execute(requested.id);
