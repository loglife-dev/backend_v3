...
import { UpdateBudgetUseCase } from "../../modules/budget/useCases/update/BudgetUseCase";
...
describe("Update budget", () => {
    beforeEach(() => {
        ...
        updateBudgetUseCase = new UpdateBudgetUseCase(budgetRepositoryInMemory);
    });

    it("Should be able to update one budget", async () => {
        ...
        const findBudget = await budgetRepositoryInMemory.findById(budget.id)

        const updateBudget = await updateBudgetUseCase.execute({
            id: '59fde46d-40ad-46ac-a674-a8506c4791f6',
            customer_id: '1e0b9d6a-0739-11ec-9a03-0242ac130003',
            source_hub_id: '1e0b9d6a-0739-11ec-9a03-0242ac130003',
            destination_hub_id: '1e0b9d6a-0739-11ec-9a03-0242ac130003',
        ...
        expect(updateBudget.service_type).toBe('service_test');
    })
})