...
import { DeleteBudgetUseCase } from "../../modules/budget/useCases/delete/BudgetUseCase";
...
describe("Delete a Budget", () => {
    beforeEach(() => {
        ...
        deleteBudgetUseCase = new DeleteBudgetUseCase(budgetRepositoryInMemory);
    });
    it("Should be able to exclude one budget", async () => {
        ...
        const findId = await deleteBudgetUseCase.execute(budget.id)
